...
def generate():         # I know the menu is broken trying to fix it and make it easier to use
    ...
    while True:
        ...
        print("[1] - Our HomeBrew Scripts - recommended")
        ...
        if userInput == "1":
            ...
            while True:
                ...
                exit = input("Press enter to list scripts again or enter 0 for main menu: ")
                if exit == "0":
                    break
                else:
                    continue
